    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <StatCard title="Total Posts" value={posts.length} icon={<FileText className="w-6 h-6 text-blue-600" />} bg="bg-blue-100" />
          <StatCard title="Published" value={publishedCount} icon={<Eye className="w-6 h-6 text-green-600" />} bg="bg-green-100" />
          <StatCard title="Drafts" value={draftCount} icon={<FileText className="w-6 h-6 text-yellow-600" />} bg="bg-yellow-100" />
          <StatCard title="Views" value="1.2k" icon={<BarChart3 className="w-6 h-6 text-purple-600" />} bg="bg-purple-100" />
        </div>
...
// Optional: Mini component for cleaner stat card rendering
