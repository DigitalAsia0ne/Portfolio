          ...
          <div className="col-lg-4">
            <div className="column md-mb50">
              ...
              <h6 className="p-color fw-400">
               <p><strong>Address:</strong> B-55, B Block, Sector 2, Noida, Uttar Pradesh 201301</p>
              </h6>
              <h6 className="mt-30 mb-15">
              <a href="mailto:sales@digitalasia.in">sales@digitalasia.in</a>
              </h6>
              <a href="#0" className="underline">
                <span className="fz-22 main-color"> <a href="tel:+919911567766">+91 9911 567766</a></span>
              </a>
            </div>
          </div>
          <div className="col-lg-2">
